...
export default function Auth() {
    ...
    const {loading, error, token, signInSource} = useSelector(state=>state.authSlice);
            ...
            <>
                <form onSubmit={submitHandler.bind(this,
                    ...
                    returnSecureToken: true})}>
                        ...
                        <Button type='success' disabled={!formValidity}>Submit</Button>
                        <Button type='danger' clicked={switchSignHandler} switch={true}>Sign {sign==='Up'?'In':'Up'} instead ?</Button>
                </form>
